...
st.markdown('<div>'
                '<h1 style="color: white;">Nhận diện 5 loại trái cây</h1>'
                '<p style="color: white;">Nhận diện 5 loại trái cây (dâu tây, ổi, thanh long, thơm, xoài) sử dụng model YOLOv5.</p>'
...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("D:/3year/XLAS/streamlit_final/streamlit_final/NhanDangTraiCay_Onnx_Streamlit/yolo5_5_trai_cay.onnx")
...
if img_file_buffer is not None:
    ...
    if st.button('Predict'):
        classes = ['DauTay', 'Oi', 'ThanhLong', 'Thom', 'Xoai']
        # Process image.
